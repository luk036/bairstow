...
Welcome to ``bairstow`` contributor's guide.
...
If you experience bugs or general issues with ``bairstow``, please have a look
...
You can help improve ``bairstow`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``bairstow`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``bairstow``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n bairstow python=3 six virtualenv pytest pytest-cov
    conda activate bairstow
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/bairstow.git
    cd bairstow
...
#. Install |pre-commit|_::
   ...
   ``bairstow`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/bairstow
.. _issue tracker: https://github.com/<USERNAME>/bairstow/issues
.. <-- end -->
